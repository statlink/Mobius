mvmf.contour <- function(mu1, mu2, kappa, rho, bgcol = "snow", dat = NULL,
                          col = NULL, lat = 50, long = 50) {

  m <- Directional::euclid.inv( rbind(mu1, mu2) )
  ...
  mat <- Mobius::dmvmf(wa, mu1, mu2, kappa, rho)
  ...
  rgl::points3d(mu1[1], mu1[2], mu1[3], col = 3, size = 10, pch = 15)
  rgl::points3d(mu2[1], mu2[2], mu2[3], col = 2, size = 10, pch = 15)
  if ( !is.null(dat) ) {
